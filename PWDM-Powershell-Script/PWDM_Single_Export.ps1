...
$connected_project_id = '370eeab6-7093-44a9-a90a-ec4697e00421' # AMKI-JTC

$export_path = "C:\Users\YK\Desktop\JTC Intern\PWDM Export Script\PWDM Export" # The top level folder path to export PWDM content for the target connected project
